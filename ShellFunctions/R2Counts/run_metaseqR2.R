...
metaseqr2(
    ...
    #embedCols=list(
    #    idCol=opt$embedCols_id,
    #    gcCol=opt$embedCols_gc,
    #    nameCol=opt$embedCols_name,
    #    btCol=opt$embedCols_bt
    #),
    ...
    #exportWhat=opt$xprtwhat,
    exportWhat=c("annotation","p_value","adj_p_value","fold_change","stats",
        "counts","flags"),
    #exportScale=opt$xprtscale,
    exportScale="natural",
    #exportValues=opt$xprtvalues,
    exportValues="normalized",
    #exportStats=opt$xprtstats,
    exportStats="mean",
